...
export default class Html5CustomVideo extends React.Component<IHtml5CustomVideoProps> {
  public render(): React.ReactElement<IHtml5CustomVideoProps> {
    ...
    return (
      <section className={`${styles.html5CustomVideo} ${hasTeamsContext ? styles.teams : ''}`}>
